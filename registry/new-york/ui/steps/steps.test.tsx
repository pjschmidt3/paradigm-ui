...
describe('Steps component', () => {
  describe('Basic rendering', () => {
    ...
    it('should render descriptions when provided', () => {
      render(<Steps steps={stepsWithDescriptions} />)
    ...
    it('should default to first step (currentStep = 0)', () => {
      const { container } = render(<Steps steps={basicSteps} />)
  ...
  describe('Step states', () => {
    it('should mark steps before currentStep as completed', () => {
      const { container } = render(
        <Steps currentStep={2} steps={basicSteps} />
      )
    ...
    it('should mark current step with ring', () => {
      const { container } = render(
        <Steps currentStep={1} steps={basicSteps} />
      )
      const stepCircles = container.querySelectorAll('.rounded-full.text-sm')
    ...
    it('should mark steps after currentStep as upcoming', () => {
      const { container } = render(
        <Steps currentStep={0} steps={basicSteps} />
      )
      const stepCircles = container.querySelectorAll('.rounded-full.text-sm')
  ...
  describe('Variants', () => {
    it('should show numbers by default', () => {
      render(<Steps steps={basicSteps} variant="numbers" />)
    ...
    it('should show empty circles with dots variant', () => {
      render(
        <Steps steps={basicSteps} variant="dots" />
      )
  ...
  describe('Orientation', () => {
    ...
    it('should apply vertical orientation', () => {
      const { container } = render(
        <Steps orientation="vertical" steps={basicSteps} />
      )
      const wrapper = container.firstChild as HTMLElement
  ...
  describe('Edge cases', () => {
    it('should handle single step', () => {
      render(<Steps steps={[{ label: 'Only Step' }]} />)
  ...
  describe('Custom className', () => {
    it('should merge custom className with default classes', () => {
      const { container } = render(
        <Steps className="custom-class" steps={basicSteps} />
      )
      const wrapper = container.firstChild as HTMLElement
  ...
  describe('Sizes', () => {
    it('should apply small size classes', () => {
      const { container } = render(
        <Steps size="sm" steps={basicSteps} />
      )
    ...
    it('should apply large size classes', () => {
      const { container } = render(
        <Steps size="lg" steps={basicSteps} />
      )
